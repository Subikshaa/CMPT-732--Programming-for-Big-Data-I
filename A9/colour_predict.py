...
def main(inputs):
    ...
    classifier = MultilayerPerceptronClassifier(featuresCol='features',labelCol='label',layers= [3, 25, 25],seed= 123)
    ...
    lab_classifier = MultilayerPerceptronClassifier(featuresCol='features',labelCol='label',layers= [3, 25, 25],seed=123)
    lab_pipeline = Pipeline(stages=[sqlTrans, lab_assembler, lab_word_indexer, lab_classifier])
